...
const RevenueChart = () => {
	...
	return (
		<motion.div
			className='bg-white shadow-md rounded-xl p-6 border border-gray-200 mb-8'
		...
		>
			<div className='flex justify-between items-center mb-6'>
				...
				<select
					className='bg-gray-50 text-gray-900 rounded-md px-3 py-1 border border-gray-300 focus:outline-none focus:ring-2 focus:ring-indigo-500'
